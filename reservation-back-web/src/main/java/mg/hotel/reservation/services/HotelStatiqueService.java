...
@Service
public class HotelStatiqueService {
    ...
    private boolean isPayementValid(ProcessReservationRequest processReservation) {
        return processReservation.getPayement() != null
                && processReservation.getPayement().getDateFinValidite() != null
                && processReservation.getPayement().getDateFinValidite().isValid();
    }
